...
for time=0:step:10
    ...
    for j=1:Ng
        ...
        for k=1:size(boundary,2)
            ...
            if boundary(k)==j  && j~=935+5 && j~=936+5 && j~=937+5 && j~=938+5 && j~=932+5 && j~=933+5 && j~=934+5 && j~=931+5 && j~=930+5 || j==345+10 || j==346+10 || j==347+10 || j==348+10 || j== 373+13 || j==374+13 || j==375+13 || j==376+13 ||j==377+13 || j==378+13 || j==349+10 || j==350+10
                found=1;
            end
        end
        
        if j<=3*ne_y+1 -12 && j>=15
        ...
        if found==1
            ...
            for i=1:2*Ng+Ne
                b(i)=b(i)-Global1(i,j)*V-Global1(i,Ng+j)*0;
    ...
    for i=1:ne_x
        ...
        for j=1:ne_y
            ...
            str = sprintf('Example 3.3, Time = %f s' ,time);
            axis([0 2 0 2])
            title(str);
            xlabel('x');
            ylabel('y');
